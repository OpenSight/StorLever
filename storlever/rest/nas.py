...
def post_smb_share_list(request):
    ...
    smb_mgr.add_share_conf(new_share_conf["share_name"],
                           ...
                           new_share_conf.get("force_create_mode", 0777),
                           new_share_conf.get("force_directory_mode", 0777),
...
def put_smb_share_conf(request):
    ...
    smb_mgr.set_share_conf(share_conf["share_name"],
                           ...
                           share_conf.get("create_mask", 0744),
                           share_conf.get("directory_mask", 0755),
                           share_conf.get("guest_ok", False),
                           share_conf.get("read_only", True),
                           share_conf.get("browseable", True),
                           share_conf.get("force_create_mode", 0777),
                           share_conf.get("force_directory_mode", 0777),
