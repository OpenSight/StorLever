...
def regist_system(mgr):
    ...
    mgr.add_leaf_node("system-info", "INTER_NODE_System", leaf_text, "partials/system-info.pt")
    leaf_text = _("System Statistics")
    mgr.add_leaf_node("statistics", "INTER_NODE_System", leaf_text, "partials/statistics.pt")
    leaf_text = _("Service Information")
    mgr.add_leaf_node("service", "INTER_NODE_System", leaf_text, "partials/")
    leaf_text = _("User Management")
    mgr.add_leaf_node("user", "INTER_NODE_System", leaf_text, "partials/")
    leaf_text = _("Module Management")
    mgr.add_leaf_node("module", "INTER_NODE_System", leaf_text, "partials/")
    ...
    mgr.add_leaf_node("interface", "INTER_NODE_Network", leaf_text, "partials/")
    leaf_text = _("Bond Management")
    mgr.add_leaf_node("bond", "INTER_NODE_Network", leaf_text, "partials/")
    leaf_text = _("Network Settings")
    mgr.add_leaf_node("net-settings", "INTER_NODE_Network", leaf_text, "partials/")

    inter_text = _("Tools")
    mgr.add_intermediate_node("INTER_NODE_Tools", "ROOT_NODE_System", inter_text, "")
    leaf_text = _("NTP")
    mgr.add_leaf_node("NTP", "INTER_NODE_Tools", leaf_text, "partials/")
    leaf_text = _("SNMP")
    mgr.add_leaf_node("SNMP", "INTER_NODE_Tools", leaf_text, "partials/")
    leaf_text = _("Zabbix")
    mgr.add_leaf_node("Zabbix", "INTER_NODE_Tools", leaf_text, "partials/")
...
def regist_store(mgr):
    ...
    leaf_text = _("Store")
    mgr.add_leaf_node("store", "INTER_NODE_Store", leaf_text, "partials/")
