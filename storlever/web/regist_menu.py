...
def regist_system(mgr):
    ...
    mgr.add_leaf_node("LEAF_NODE_SystemInfo", "INTER_NODE_System", leaf_text, "static/views/system-info.html")
    leaf_text = _("System Statistics")
    mgr.add_leaf_node("LEAF_NODE_Statistics", "INTER_NODE_System", leaf_text, "static/views/statistics.html")
